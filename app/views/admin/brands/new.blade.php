...
<!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="#"><i class="fa fa-plus"></i> Nueva Marca</a></li>
          </ol>
        </section>
        <div class="row">
                ...
                <div class="box-body chat" id="chat-box">
                  ...
                  <form class="new-user-form" method="POST" action="{{ URL::to('administrador/nueva-marca/enviar') }}" enctype="multipart/form-data"> 
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="name" placeholder="Nombre de la marca" value="{{ Input::old('name') }}">
                    </div>
                    <div class="input-group">
