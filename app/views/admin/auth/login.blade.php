...
<div class="login-box">
  <div class="login-logo logo-login">
    <a href="{{ URL::to('administrador') }}"><b>Sistema de administracion eljuzgador.com</b></a>
  </div><!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="row">
      <div class="col-xs-8 pull-right">
        <button type="submit" class="btn btn-primary btn-block btn-flat logMeIn" value="{{ URL::to('administrador/login/enviar') }}">Iniciar Sesión</button>
      </div><!-- /.col -->
