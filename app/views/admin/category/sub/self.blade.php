...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ Request::url() }}"><i class="fa fa-cogs"></i> Modificar Sub-Categoría</a></li>
    </ol>
  </section>
  <div class="row">
    <div class="col-xs-12 col-md-10 col-md-offset-1 formulario">
      <div class="box box-success">
        ...
        <div class="box-body chat" id="chat-box">
          ...
          <div class="col-xs-12">
            <form class="new-user-form" method="POST" action="{{ URL::to('administrador/sub-categorias/ver-sub-categorias/'.$subcat->id.'/enviar') }}"  enctype="multipart/form-data">
