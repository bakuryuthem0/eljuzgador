...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#"><i class="fa fa-search"></i> Ver facturas</a></li>
      </ol>
    </section>
    <div class="row">
          	...
          	<div class="box box-success">
                ...
                <div class="box-body content-fluid">
                	<div class="table-responsive">
		                <table id="example1" class="table table-bordered table-striped valign-table text-center">
		                    <thead>
		                    	<tr>
									<th>Id</th>
									<th>Usuario</th>
								...
								<tr>
									...
									<td>
										...
										@foreach($f->compras as $c)
											<?php $price = $c->items->price;?>
											@if(!is_null($c->items->offertItem))
												<?php $total += ($price - $price*$c->items->offertItem->offerts->percent/100)*$c->qty; ?>
											@else
												<?php $total += $price*$c->qty; ?>
											@endif
										@endforeach
										{{ $total }}
									</td>
