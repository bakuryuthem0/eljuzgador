<?php require "layouts/header.php";?>
	...
	<section class="row">
		<div class="no-padding col-xs-12 col-md-8 main-news zoom-container">
		...
		<div class="no-padding col-xs-12 col-md-4 main-news">
			...
			<div class="col-xs-4 col-md-12 side-news zoom-container">
				<div class="zoom-caption">
					<div class="zoom-caption-inner">
						<div class="date-feat">
							<i class="fa fa-clock-o"></i>
		...
		<div class="clearfix no-gutter">
			<div id="main-content" class="col-md-9 fix-right">
				<div class="gutter-7px">
					<div class="col-xs-12 col-sm-4 active">
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/4.jpg" /></a></div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/11.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.php">More...</a>
							</div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/13.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.php">More...</a>
							</div>
					...
					<div class="col-xs-12 col-sm-4 active">
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/14.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.php">More...</a>
							</div>
					...
					<div class="col-xs-12 col-sm-4">
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/5.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.php">More...</a>
							</div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/9.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.php">More...</a>
							</div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/12.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.php">More...</a>
							</div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.php"><img src="images/15.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.php">More...</a>
							</div>
				...
				<div class="col-xs-12 text-center btn-load-more">
					<button class="btn btn-info load-more" data-target=".gutter-7px">Mas Noticias</button>
				</div>
			</div>
